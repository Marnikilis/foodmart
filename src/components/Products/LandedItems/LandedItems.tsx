...
const landedProducts = [
  {img: beans, title: 'Jelly beans exxotics', quantity: '1 unit', rating: '4.5', price: '$18.00'},
  {img: cider, title: 'Growers cider', quantity: '1 unit', rating: '4.0', price: '$5.00'},
  {img: grapes, title: 'Fresh grapes', quantity: '1 kg', rating: '4.5', price: '$6.00'},
  {img: ketchup, title: 'Heinz tomato ketchup', quantity: '1 unit', rating: '5.0', price: '$9.00'},
  {img: juiceMelon, title: 'Sunstar Fresh Melon Juice', quantity: '1 unit', rating: '3.5', price: '$12.00'},
  {img: beans, title: 'Jelly beans exxotics', quantity: '1 unit', rating: '4.5', price: '$18.00'},
  {img: cider, title: 'Growers cider', quantity: '1 unit', rating: '4.0', price: '$5.00'},
  {img: grapes, title: 'Fresh grapes', quantity: '1 kg', rating: '4.5', price: '$6.00'},
  {img: ketchup, title: 'Heinz tomato ketchup', quantity: '1 unit', rating: '5.0', price: '$9.00'},
...
const LandedItems = () => {
  ...
  return (
    <ProductCarousel
      products={landedProducts}
      heading={'Just landed items'}/>
  );
};
