      ...
      <div className={styles.container}>
        <div className={styles.productsNav}>
          ...
          <div className={styles.navigation}>
            ...
            <NavLink to="/fruits&" className={styles.link}>
              Fruits & Veges
            </NavLink>
            <NavLink to="/juicesVeges" className={styles.link}>
              Juices
            </NavLink>
            <NavLink to="/breadsSweets" className={styles.link}>
              Breads & Sweets
            </NavLink>
            <NavLink to="/oil&ghee" className={styles.link}>
              Oil & Ghee
            </NavLink>
            <NavLink to="/rawMeats" className={styles.link}>
              Raw Meats
            </NavLink>
            <NavLink to="/naturalHerbs" className={styles.link}>
              Natural Herbs
            </NavLink>
          </div>
        </div>
